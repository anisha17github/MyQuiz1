class form7 {
    ...
    display(){
      ...
      this.question.html("Question:- Who always carries sanitiser in his/hers pocket? " );
      this.question.position(150, 80);
      this.option1.html("1: Sammy " );
      this.option1.position(150, 100);
      this.option2.html("2: Kenji" );
      this.option2.position(150, 120);
      this.option3.html("3: Ben" );
      this.option3.position(150, 140);
      this.option4.html("4: Mitch" );
