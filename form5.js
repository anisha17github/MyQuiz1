class form5 {
    ...
    display(){
      ...
      this.question.html("Question:- Who is Yasmina?")
      this.question.position(150, 80);
      this.option1.html("1: a trainer " );
      this.option1.position(150, 100);
      this.option2.html("2: a coach" );
      this.option2.position(150, 120);
      this.option3.html("3: an athlette " );
      this.option3.position(150, 140);
      this.option4.html("4: a swimmer" );
