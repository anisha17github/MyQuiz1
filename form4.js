class form4 {
    ...
    display(){
      ...
      this.question.html("What was the name of the dinosaur which Ben found in Dr. Wu's lab? " );
      this.question.position(150, 80);
      this.option1.html("1: Tommy " );
      this.option1.position(150, 100);
      this.option2.html("2: Bumpy" );
      this.option2.position(150, 120);
      this.option3.html("3: Indominus " );
      this.option3.position(150, 140);
      this.option4.html("4: Scorpius" );
