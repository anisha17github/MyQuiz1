class form3 {
    ...
    display(){
      ...
      this.question.html("Question:- Who sent Sammy to investigate? " );
      this.question.position(150, 80);
      this.option1.html("1: George.ltd " );
      this.option1.position(150, 100);
      this.option2.html("2: Sango Organisation" );
      this.option2.position(150, 120);
      this.option3.html("3: Fanta Corp " );
      this.option3.position(150, 140);
      this.option4.html("4: MantaCorp" );
