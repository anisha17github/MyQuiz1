class form2 {
    ...
    display(){
      ...
      this.question.html("Question:- Who is standing behind Darius? " );
      this.question.position(150, 80);
      this.option1.html("1: Kenji " );
      this.option1.position(150, 100);
      this.option2.html("2: Darius's father" );
      this.option2.position(150, 120);
      this.option3.html("3: Toro" );
      this.option3.position(150, 140);
      this.option4.html("4: Darius's brother" );
