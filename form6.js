class form6 {
    ...
    display(){
      ...
      this.question.html("Question:-  What are the charecteristics of Kenji? " );
      this.question.position(150, 80);
      this.option1.html("1: evil and cruel" );
      this.option1.position(150, 100);
      this.option2.html("2: hopeful and confident" );
      this.option2.position(150, 120);
      this.option3.html("3: helpful and funny " );
      this.option3.position(150, 140);
      this.option4.html("4: depressed and confused" );
